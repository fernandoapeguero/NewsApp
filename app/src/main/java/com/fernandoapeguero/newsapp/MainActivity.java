...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<NewsData>>{
    ...
    private String HTTP_REQUEST_URL = "http://content.guardianapis.com/search?from-date=2001-01-01&to-date=2017-12-01&page-size=10&q=renewable%20energy&api-key=fba7be92-00a1-4580-b783-918c17fb0bd8";
